...
# Agent2a: Query Processing Agent
def process_query(query):
    """Process and enhance the user query for better retrieval"""
    ...
    print(f"Query processed: '{query}' -> Enhanced: '{enhanced_query}'")
    return enhanced_query

# Agent2b: Document Retrieval Agent
...
def run_four_agent_rag_system(doc_path):
    ...
    print("Customer service assistant (Four-Agent RAG system) ready! Ask product-related questions.")
    ...
    while True:
        ...
        # Step 2a: Process and enhance the query
        enhanced_query = process_query(user_input)
        
        # Step 2b: Search for relevant documents
...
if __name__ == "__main__":
    ...
    print("Starting 4-Agent RAG Customer Service System (Local Embeddings)...")
    print("Agent 1: Document Loader")
    print("Agent 2a: Query Processing Agent") 
    print("Agent 2b: Document Retrieval Agent")
